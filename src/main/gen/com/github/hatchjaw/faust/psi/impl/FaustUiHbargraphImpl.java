...
public class FaustUiHbargraphImpl extends ASTWrapperPsiElement implements FaustUiHbargraph {

  public FaustUiHbargraphImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiHbargraph(this);
  }
