...
public class FaustParallelCompImpl extends FaustExpressionImpl implements FaustParallelComp {

  public FaustParallelCompImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitParallelComp(this);
  }
