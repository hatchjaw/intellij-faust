...
public class FaustSoundfilePrimImpl extends ASTWrapperPsiElement implements FaustSoundfilePrim {

  public FaustSoundfilePrimImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitSoundfilePrim(this);
  }
