...
public class FaustUIElementGraphImpl extends ASTWrapperPsiElement implements FaustUIElementGraph {

  public FaustUIElementGraphImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUIElementGraph(this);
  }
