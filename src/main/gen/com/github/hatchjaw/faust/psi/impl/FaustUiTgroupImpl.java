...
public class FaustUiTgroupImpl extends ASTWrapperPsiElement implements FaustUiTgroup {

  public FaustUiTgroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiTgroup(this);
  }
