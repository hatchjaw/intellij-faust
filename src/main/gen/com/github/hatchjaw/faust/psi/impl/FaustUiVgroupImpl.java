...
public class FaustUiVgroupImpl extends ASTWrapperPsiElement implements FaustUiVgroup {

  public FaustUiVgroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiVgroup(this);
  }
