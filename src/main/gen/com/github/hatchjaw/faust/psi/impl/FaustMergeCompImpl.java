...
public class FaustMergeCompImpl extends FaustExpressionImpl implements FaustMergeComp {

  public FaustMergeCompImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitMergeComp(this);
  }
