...
public class FaustMergeArgImpl extends FaustArgumentImpl implements FaustMergeArg {

  public FaustMergeArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitMergeArg(this);
  }
