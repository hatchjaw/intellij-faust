...
public class FaustUiHsliderImpl extends ASTWrapperPsiElement implements FaustUiHslider {

  public FaustUiHsliderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiHslider(this);
  }
