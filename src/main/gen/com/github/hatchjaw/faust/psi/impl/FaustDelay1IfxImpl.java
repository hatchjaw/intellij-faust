...
public class FaustDelay1IfxImpl extends FaustInfixImpl implements FaustDelay1Ifx {

  public FaustDelay1IfxImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitDelay1Ifx(this);
  }
