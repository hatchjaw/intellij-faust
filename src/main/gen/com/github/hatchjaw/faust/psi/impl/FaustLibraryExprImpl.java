...
public class FaustLibraryExprImpl extends ASTWrapperPsiElement implements FaustLibraryExpr {

  public FaustLibraryExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitLibraryExpr(this);
  }
