...
public class FaustLetrecExprImpl extends FaustExpressionImpl implements FaustLetrecExpr {

  public FaustLetrecExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitLetrecExpr(this);
  }
