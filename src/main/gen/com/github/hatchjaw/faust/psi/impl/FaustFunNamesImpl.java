...
public class FaustFunNamesImpl extends ASTWrapperPsiElement implements FaustFunNames {

  public FaustFunNamesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitFunNames(this);
  }
  ...
  @Override
  @Nullable
  public FaustFunNames getFunNames() {
    return findChildByClass(FaustFunNames.class);
  }
