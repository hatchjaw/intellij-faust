...
public class FaustUIElementGroupImpl extends ASTWrapperPsiElement implements FaustUIElementGroup {

  public FaustUIElementGroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUIElementGroup(this);
  }
