...
public class FaustUiCheckboxImpl extends ASTWrapperPsiElement implements FaustUiCheckbox {

  public FaustUiCheckboxImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiCheckbox(this);
  }
