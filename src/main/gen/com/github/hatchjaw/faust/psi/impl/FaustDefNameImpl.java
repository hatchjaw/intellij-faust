...
public class FaustDefNameImpl extends ASTWrapperPsiElement implements FaustDefName {

  public FaustDefNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitDefName(this);
  }
  ...
  @Override
  @NotNull
  public FaustIdent getIdent() {
    return findNotNullChildByClass(FaustIdent.class);
  }
