...
public class FaustAttachExprImpl extends ASTWrapperPsiElement implements FaustAttachExpr {

  public FaustAttachExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitAttachExpr(this);
  }
