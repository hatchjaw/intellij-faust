...
public class FaustIterParImpl extends ASTWrapperPsiElement implements FaustIterPar {

  public FaustIterParImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitIterPar(this);
  }
