...
public class FaustUqStringImpl extends ASTWrapperPsiElement implements FaustUqString {

  public FaustUqStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUqString(this);
  }
