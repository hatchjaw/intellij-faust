...
public class FaustUIElementButtonImpl extends ASTWrapperPsiElement implements FaustUIElementButton {

  public FaustUIElementButtonImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUIElementButton(this);
  }
