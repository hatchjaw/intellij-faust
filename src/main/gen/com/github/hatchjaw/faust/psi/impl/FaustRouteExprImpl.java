...
public class FaustRouteExprImpl extends ASTWrapperPsiElement implements FaustRouteExpr {

  public FaustRouteExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitRouteExpr(this);
  }
