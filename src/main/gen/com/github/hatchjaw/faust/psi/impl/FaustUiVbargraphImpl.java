...
public class FaustUiVbargraphImpl extends ASTWrapperPsiElement implements FaustUiVbargraph {

  public FaustUiVbargraphImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiVbargraph(this);
  }
