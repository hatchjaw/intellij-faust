...
public class FaustUIElementSliderImpl extends ASTWrapperPsiElement implements FaustUIElementSlider {

  public FaustUIElementSliderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUIElementSlider(this);
  }
  ...
  public FaustArgumentSeq getArgumentSeq() {
    return findNotNullChildByClass(FaustArgumentSeq.class);
  }
