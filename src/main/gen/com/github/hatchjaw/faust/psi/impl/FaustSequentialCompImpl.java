...
public class FaustSequentialCompImpl extends FaustExpressionImpl implements FaustSequentialComp {

  public FaustSequentialCompImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitSequentialComp(this);
  }
