...
public class FaustUiVsliderImpl extends ASTWrapperPsiElement implements FaustUiVslider {

  public FaustUiVsliderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiVslider(this);
  }
