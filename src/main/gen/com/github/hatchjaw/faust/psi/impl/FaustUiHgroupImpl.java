...
public class FaustUiHgroupImpl extends ASTWrapperPsiElement implements FaustUiHgroup {

  public FaustUiHgroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiHgroup(this);
  }
