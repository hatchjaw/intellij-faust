...
public class FaustUiNentryImpl extends ASTWrapperPsiElement implements FaustUiNentry {

  public FaustUiNentryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitUiNentry(this);
  }
