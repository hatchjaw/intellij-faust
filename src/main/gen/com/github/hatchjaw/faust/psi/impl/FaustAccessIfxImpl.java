...
public class FaustAccessIfxImpl extends FaustInfixImpl implements FaustAccessIfx {

  public FaustAccessIfxImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitAccessIfx(this);
  }
