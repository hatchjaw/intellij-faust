...
public class FaustLetrecExpressionImpl extends ASTWrapperPsiElement implements FaustLetrecExpression {

  public FaustLetrecExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitLetrecExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<FaustDiffEquation> getDiffEquationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FaustDiffEquation.class);
  }
