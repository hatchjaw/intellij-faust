...
public class FaustInfixArgImpl extends FaustArgumentImpl implements FaustInfixArg {

  public FaustInfixArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitInfixArg(this);
  }
