...
public class FaustPatternAbstractionImpl extends ASTWrapperPsiElement implements FaustPatternAbstraction {

  public FaustPatternAbstractionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FaustRule> getRuleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FaustRule.class);
  }
