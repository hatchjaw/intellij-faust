...
public class FaustEnvironmentExprImpl extends ASTWrapperPsiElement implements FaustEnvironmentExpr {

  public FaustEnvironmentExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitEnvironmentExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<FaustFunctionDefinition> getFunctionDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FaustFunctionDefinition.class);
  }
