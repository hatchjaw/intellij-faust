...
public class FaustLambdaAbstractionImpl extends ASTWrapperPsiElement implements FaustLambdaAbstraction {

  public FaustLambdaAbstractionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitLambdaAbstraction(this);
  }
