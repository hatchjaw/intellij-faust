...
public class FaustIterSeqImpl extends ASTWrapperPsiElement implements FaustIterSeq {

  public FaustIterSeqImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FaustVisitor visitor) {
    visitor.visitIterSeq(this);
  }
