...
public class FaustAccessImpl extends ASTWrapperPsiElement implements FaustAccess {

  public FaustAccessImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FaustFunctionCall> getFunctionCallList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FaustFunctionCall.class);
  }
